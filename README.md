...
9. Allow admin to view a dedicated dashboard
...
10. Allow admin to review submitted forms
...
## Project Management
The project managment tool we've used to track our progress for this assesment is Trello. We have 10 columns in our board, each of which contribute to an agile approach of product development.
